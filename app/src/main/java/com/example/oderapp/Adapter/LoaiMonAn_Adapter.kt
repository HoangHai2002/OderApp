...
import com.example.oderapp.ViewHolder.LoaiMonAn_ViewHolder

class LoaiMonAn_Adapter(var listData : MutableList<LoaiMonAn>, val listener : itf_Click_LoaiMonAn): RecyclerView.Adapter<LoaiMonAn_ViewHolder>() {
    var selectedPosition = RecyclerView.NO_POSITION
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LoaiMonAn_ViewHolder {
        var view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_khuvucban, parent, false)
        return LoaiMonAn_ViewHolder(view)
    }
    ...
    override fun onBindViewHolder(holder: LoaiMonAn_ViewHolder, position: Int) {
